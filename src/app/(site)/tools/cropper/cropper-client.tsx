                  ...
                  <div className="p-3 bg-secondary rounded-xl border border-border/60 space-y-3 pt-2.5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full bg-card border border-border hover:border-primary/50 text-foreground text-xs rounded-xl p-2 outline-none transition-all duration-200 cursor-pointer [color-scheme:light] dark:[color-scheme:dark]"
                      >
