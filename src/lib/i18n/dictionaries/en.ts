export const en = {
  ...
  "shared": {
    ...
    "related": {
      ...
      "exif-cleaner-info": "Strip location and camera info from photos locally.",
      ...
      "compressor-savings": "Reduce file sizes by up to 90% while keeping quality.",
      ...
      "converter-formats": "Convert files between JPG, PNG, WebP, PDF, and vectors.",
  ...
  "tools": {
    ...
    "exif-cleaner": {
      ...
      "alreadyCleanNotice": "This image is already clean. No EXIF, GPS, camera, or software tags were detected.",
      "coordinatesNotice": "This image reveals exactly where the photo was taken:"
    },
    "id-protector": {
      ...
      "uploadInstructions": "Drag & drop your KTP, SIM, passport, or ID photo here, or click to browse."
    },
    "qr-toolkit": {
    ...
    "resizer": {
      ...
      "cropBehaviorHelp": "Fills preset size entirely, trimming excess dimensions from the center aspect.",
      "fitBehaviorHelp": "Contains full image inside preset boundaries, padding with transparent or solid background."
    },
    "steganography": {
      ...
      "passwordHelp": "Locking with a password derivates a 256-bit key to encrypt your message. Extracting without the correct password yields unreadable ciphertext."
    },
    "upscaler": {
      ...
      "gpuWarning": "Runs 100% in your browser — your image never leaves your device.",
      "localWarning": "Processing happens locally and can take a while for large images or slower devices — keep this tab open."
    },
    "watermark": {
      "intro": "Protect and brand your images with text or logo watermarks — entirely in your browser. Drag the watermark exactly where you want it, tile it diagonally across the whole image, rotate it, and tune the opacity for the look you want. Watermark a single image or a whole batch at once. No upload, no sign-up — your images and logo never leave your device.",
      "howItWorks": {
      ...
      "previewResolutionNotice": "Preview resolution is capped at 1200px. Watermark applies to full-resolution on export."
    },
    "stock-finder": {
      "intro": "Search across Unsplash, Pexels, and Pixabay at once — and unlike most stock finders that only show photos, Alatify also surfaces illustrations and vectors. Find the perfect image, then jump straight into Alatify's editing tools to remove its background, compress it, or convert it — all free, no sign-up.",
      "howItWorks": {
        "step1": "Type a keyword to search free stock across Unsplash, Pexels, and Pixabay at once.",
        "step2": "Narrow by content type (photos, illustrations, or vectors), source, and orientation.",
        "step3": "Choose the image you want.",
        "step4": "Open it in one click in Alatify's tools, or download it directly."
      },
      "useCases": {
        "case1": "High-quality, royalty-free photography for blogs, articles, and social posts.",
        "case2": "Scalable graphics for presentations, designs, and thumbnails — not just photos.",
        "case3": "Wide, high-resolution shots for websites and headers.",
        "case4": "Send any result straight into Alatify to cut out the background, compress, or convert."
      },
      "faq": {
