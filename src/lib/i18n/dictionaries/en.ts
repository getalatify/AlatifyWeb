export const en = {
  ...
  about: {
    ...
    why: {
      ...
      p2: "Alatify is different. Your files are processed on your own device, using your own hardware, and they are never uploaded. We would rather build tools that are fast and honest about what they do than tools that ask you to trust a server you cannot see.",
    },
    offer: {
  ...
  privacy: {
    ...
    collect: {
      ...
      li3: "Your usage. We do not monitor which tools you open, how often you use them, or what settings you choose.",
      li4: "Anything that identifies you. No Google Analytics, no Facebook Pixel, no Mixpanel or Hotjar, no third-party cookies, and no fingerprinting. Even our fonts ship with the site instead of loading from Google.",
    ...
    rights: {
      ...
      li3: "There is nothing to opt out of. We set no tracking cookies and run no analytics, so you will not find a consent banner or a preference centre here.",
    },
    contact: {
      start: "Found something on this page that does not match what the code does? The source is public, and we would rather hear about it. Contact us at",
      end: "",
    },
  },
  terms: {
  ...
  tools: {
    ...
    blur: {
      ...
      faq: {
        ...
        a4: "No. Loading the image, drawing the boxes, rendering the pixels, and exporting the file all happen inside your browser. The original never leaves your machine, and you can confirm it in the Network tab.",
      },
      privacyNotice:
  ...
  embed: {
    ...
    generator: {
      ...
      "toastCopiedDesc": "Embed snippet is ready to be pasted into your website.",
      "toastCopyFailed": "Failed to copy code snippet.",
      "backHome": "Back to home",
      "badge": "Developer Embed Code",
      "title": "Embed Alatify's Tools",
      "intro": "Distribute our privacy-first, 100% client-side widgets on your own blog, app, or website. They run completely inside the user's browser, with no server bandwidth or sign-ups required.",
      "selectLabel": "Select Tool to Embed",
      "selectPlaceholder": "Choose a tool",
      "snippetLabel": "HTML Embed Snippet",
      "copied": "Copied!",
      "copyCode": "Copy Code",
      "featuresTitle": "How It Works & Features",
      "feature1Title": "Zero Server Overhead",
      "feature1Desc": "The widget runs AI models and utilities completely client-side in the user's browser. It uses WebGPU acceleration when available and falls back to CPU cleanly.",
      "feature2Title": "Privacy-First Integration",
      "feature2Desc": "Files never touch our servers or yours. The entire operation is sandboxable, meaning absolute privacy for your site's users.",
      "previewTitle": "Live Interactive Preview",
      "openFull": "Open full preview ↗",
      "previewToolTitle": "{name} Preview",
      "previewPrompt": "Click below to load the live widget preview. This prevents loading the widget until you are ready to test it.",
