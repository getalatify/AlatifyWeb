export const en = {
  ...
  embed: {
    ...
    toast: {
      ...
      copiedDesc: "Embed snippet is ready to be pasted into your website.",
      copyError: "Failed to copy code snippet.",
    },
    backToHome: "Back to home",
    devEmbedCode: "Developer Embed Code",
    title: "Embed Alatify's Tools",
    subtitle: "Distribute our privacy-first, 100% client-side widgets on your own blog, app, or website. They run completely inside the user's browser, so no server bandwidth or sign-ups are required.",
    selectLabel: "Select Tool to Embed",
    choosePlaceholder: "Choose a tool",
    snippetLabel: "HTML Embed Snippet",
    copied: "Copied!",
    copyCode: "Copy Code",
    featuresTitle: "How It Works & Features",
    features: {
      zeroOverhead: "Zero Server Overhead",
      zeroOverheadDesc: "The widget runs AI models and utilities completely client-side in the user's browser. It uses WebGPU acceleration when available and falls back to CPU cleanly.",
      privacyFirst: "Privacy-First Integration",
      privacyFirstDesc: "Files never touch our servers or yours. The entire operation is sandboxable, meaning absolute privacy for your site's users.",
    },
    previewTitle: "Live Interactive Preview",
    openFull: "Open full preview ↗",
    previewFor: "{toolName} Preview",
    previewWarning: "Click below to load the live widget preview. This prevents loading the widget until you are ready to test it.",
