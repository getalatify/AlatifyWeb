export const id = {
  ...
  embed: {
    ...
    toast: {
      copiedTitle: "Berhasil disalin!",
      copiedDesc: "Snippet embed siap ditempel ke situs web kamu.",
      copyError: "Gagal menyalin snippet kode.",
    },
    backToHome: "Kembali ke beranda",
    devEmbedCode: "Kode Semat Developer",
    title: "Sematkan Alat Alatify",
    subtitle: "Bagikan widget kami yang mengutamakan privasi dan berjalan 100% di browser pada blog, aplikasi, atau situs web kamu sendiri. Widget berjalan sepenuhnya di browser pengguna, jadi tidak butuh bandwidth server atau pendaftaran.",
    selectLabel: "Pilih Alat untuk Disematkan",
    choosePlaceholder: "Pilih alat",
    snippetLabel: "Snippet Semat HTML",
    copied: "Tersalin!",
    copyCode: "Salin Kode",
    featuresTitle: "Cara Kerja & Fitur",
    features: {
      zeroOverhead: "Tanpa Beban Server",
      zeroOverheadDesc: "Widget menjalankan model AI dan utilitas sepenuhnya di browser pengguna. Menggunakan akselerasi WebGPU jika ada, dan otomatis beralih ke CPU dengan lancar.",
      privacyFirst: "Integrasi Aman & Privat",
      privacyFirstDesc: "Berkas tidak pernah masuk ke server kami maupun server kamu. Seluruh proses berjalan di dalam sandbox, menjamin privasi total untuk pengunjung situs kamu.",
    },
    previewTitle: "Pratinjau Interaktif Langsung",
    openFull: "Buka pratinjau penuh ↗",
    previewFor: "Pratinjau {toolName}",
    previewWarning: "Klik tombol di bawah untuk memuat pratinjau widget. Ini menjaga agar widget tidak dimuat sampai kamu siap mencobanya.",
    loadPreview: "Muat Pratinjau Langsung",
  },
  imagePreview: {
    alt: "Pratinjau",
    replace: "Ganti",
