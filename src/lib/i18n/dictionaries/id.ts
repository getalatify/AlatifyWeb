export const id = {
  ...
  "image-to-pdf": {
    ...
    "faq": {
      ...
      "a4": "Alat ini menyematkan gambar secara langsung ke dalam PDF. Untuk ukuran file yang optimal, Anda dapat mengompresi gambar sumber Anda menggunakan Kompresor Gambar kami sebelum menyusun.",
