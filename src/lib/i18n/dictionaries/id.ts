export const id = {
  ...
  about: {
    ...
    why: {
      ...
      p2: "Alatify beda. Filemu diproses di perangkatmu sendiri, pakai hardware-mu sendiri, dan tidak pernah diunggah. Kami lebih memilih membuat tool yang cepat dan jujur soal apa yang dilakukannya, daripada tool yang minta kamu percaya pada server yang tidak bisa kamu lihat.",
    },
    offer: {
  ...
  privacy: {
    ...
    collect: {
      ...
      li3: "Pemakaianmu. Kami tidak memantau tool mana yang kamu buka, seberapa sering kamu memakainya, atau pengaturan apa yang kamu pilih.",
      li4: "Apa pun yang bisa mengidentifikasi kamu. Tanpa Google Analytics, tanpa Facebook Pixel, tanpa Mixpanel atau Hotjar, tanpa cookie pihak ketiga, dan tanpa fingerprinting. Bahkan font kami ikut terpasang bersama situs, bukan diambil dari Google.",
    ...
    rights: {
      ...
      li3: "Tidak ada yang perlu kamu tolak. Kami tidak memasang cookie pelacak dan tidak menjalankan analitik, jadi kamu tidak akan menemui banner persetujuan atau pusat pengaturan privasi di sini.",
    },
    contact: {
      start:
        "Menemukan sesuatu di halaman ini yang tidak cocok dengan isi kodenya? Source code kami publik, dan kami justru mau tahu. Hubungi kami di",
      end: "",
    },
  },
  terms: {
  ...
  tools: {
    ...
    blur: {
      ...
      faq: {
        ...
        a4: "Tidak. Memuat gambar, menggambar kotak sensor, merender piksel, dan mengekspor file semuanya terjadi di dalam browser kamu. File aslimu tidak pernah keluar dari perangkat, dan kamu bisa memastikannya di Network tab.",
      },
      privacyNotice:
