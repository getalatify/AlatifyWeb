export const id = {
  "home": {
    "hero": {
      "tagline": "Alat gambar yang mengutamakan privasi, berjalan sepenuhnya di browser kamu"
    },
    "features": {
      "card1": {
  ...
  "about": {
    ...
    "road": {
      ...
      "p2_start": "Saran dan masukan dari kamu sangat berharga. Kalau ada saran, request fitur, atau bug yang ingin dilaporkan, silakan hubungi kami di",
      "p2_end": "."
    }
  },
  "privacy": {
    "short": "Alatify tidak mengumpulkan, menyimpan, atau mengirimkan gambar maupun data pribadimu. Semua proses terjadi sepenuhnya di browser kamu. Tanpa daftar akun, tanpa pelacakan pengguna, dan bebas dari analitik pihak ketiga.",
    "collect": {
    ...
    "contact": {
      "start": "Punya pertanyaan tentang arsitektur lokal-first kami? Hubungi kami di",
      "end": ""
    }
  },
  "terms": {
    "short": "Silakan pakai Alatify dengan bebas untuk keperluan pribadi maupun komersial. Kami menyediakan alat berbasis browser ini apa adanya tanpa jaminan. Kamu bertanggung jawab penuh atas gambar yang kamu proses, dan tidak boleh memakai Alatify untuk memproses konten ilegal.",
    "license": {
    ...
    "changes": "Ketentuan ini bisa berubah sewaktu-waktu. Ketentuan terbaru yang berlaku akan selalu ditampilkan di halaman ini. Dengan terus memakai Alatify setelah ketentuan diperbarui, artinya kamu menyetujui ketentuan baru tersebut.",
    "contact": {
  ...
  "shared": {
    ...
    "related": {
      ...
      "exif-cleaner-info": "Hapus info lokasi dan kamera dari fotomu secara lokal.",
      "bg-remover": "Potong objek secara lokal langsung di browser kamu.",
      "bg-remover-backdrops": "Ekstrak subjek dan hapus background secara lokal.",
      "upscaler": "Perbesar foto 2x dan 4x langsung di perangkatmu.",
      "compressor-savings": "Kecilkan ukuran file sampai 90% tanpa merusak kualitas.",
      "compressor-offline": "Kecilkan ukuran file gambar sampai 90% secara offline.",
      "resizer-dimensions": "Ubah dimensi gambar pakai persentase atau piksel.",
      "resizer-pixels": "Ubah ukuran gambar berdasarkan piksel, rasio, atau persen.",
  ...
  "tools": {
    "compressor": {
      "intro": "Kecilkan ukuran file gambar dengan kontrol penuh. Pilih lossy untuk ukuran paling kecil, atau lossless kalau kamu mau mempertahankan tiap piksel. Semuanya jalan di browser kamu, tanpa perlu unggah.",
      "hintBubble": "Tips: Biar file-nya paling kecil, ekspor fotomu ke JPEG. Pilih PNG kalau kamu butuh latar belakang transparan.",
      "alreadyOptimised": "Sudah optimal. File ini tidak bisa dikecilkan lagi.",
      "losslessConvertDisabled": "Pilihan lossless hanya bisa dipakai saat kamu mengompres ulang file PNG asli.",
      "pngLargerNudge": "Mengubah format ke PNG malah membuat file-nya jadi lebih besar. Biar lebih kecil, coba pakai WebP atau JPEG saja.",
      "howItWorks": {
        "step1": "Masukkan satu atau beberapa gambar sekaligus.",
        "step2": "Pilih antara lossy atau lossless, lalu atur kualitas yang kamu mau.",
        "step3": "Kecilkan gambarmu seketika, langsung di perangkatmu.",
        "step4": "Simpan hasilnya satu per satu atau unduh semua sekaligus dalam format ZIP."
      },
      "useCases": {
        "case1": "Gambar yang lebih kecil bakal dimuat lebih cepat, membantu menaikkan kecepatan website dan SEO.",
        "case2": "Penuhi batas maksimal lampiran email atau unggahan web tanpa merusak kualitas gambar.",
        "case3": "Kosongkan ruang penyimpanan perangkat dengan mengecilkan koleksi fotomu yang besar.",
        "case4": "Penuhi batasan ukuran file di berbagai platform sambil menjaga gambar tetap tajam."
      },
      "faq": {
      ...
      "privacyNotice": "Alatify memproses file gambarmu sepenuhnya secara lokal menggunakan sandbox API di dalam tab browser kamu. Kami tidak pernah mengunggah file atau data pribadimu ke server mana pun, sehingga 100% aman dari kebocoran data. Kompres JPG, PNG, dan WebP secara instan dan aman di perangkatmu sendiri."
    },
    "bg-remover": {
      "sizes": {
        "isnet_quint8": "~45 MB",
      ...
      "intro": "Kebanyakan penghapus background gratis mengunggah gambarmu ke server mereka. Parahnya, banyak yang diam-diam memakai gambarmu untuk melatih AI mereka atau membatasi unduhan gratis di resolusi rendah. Alatify berjalan sepenuhnya di browser kamu memakai AI lokal yang diakselerasi GPU. Fotomu tidak pernah keluar dari perangkat. Tanpa daftar akun, tanpa watermark, tanpa batas resolusi, dan tanpa batasan jumlah foto yang kamu proses. Kualitas penuh, sepenuhnya privat, tanpa batas.",
      "howItWorks": {
        "step1": "Letakkan gambarmu di sini. File tetap tersimpan aman di perangkatmu.",
        "step2": "AI lokal mendeteksi objek utama dan menghapus background secara instan dalam hitungan detik, dengan akselerasi GPU.",
        "step3": "Dapatkan potongan gambar yang rapi dengan background transparan, langsung di resolusi penuh.",
        "step4": "Simpan hasilnya dalam format PNG transparan. Tanpa watermark, tanpa batasan."
      },
      "useCases": {
        "case1": "Foto produk dengan background transparan atau putih bersih untuk daftar Amazon, Etsy, Shopify, dan eBay.",
        ...
        "case4": "Tempatkan subjek fotomu di background apa pun untuk postingan, cerita, dan grafis."
      },
      "faq": {
      ...
      "privacyNotice": "Alatify menghapus background gambar sepenuhnya di dalam tab browser kamu menggunakan AI lokal dengan akselerasi GPU. Fotomu tidak pernah diunggah ke server, tidak pernah dipakai melatih model, dan tidak pernah dicatat, sehingga 100% aman dari kebocoran atau penyimpanan data di server. Dapatkan file PNG transparan resolusi penuh bebas watermark sepuasnya, diproses aman di perangkatmu sendiri.",
      "onnxNotice": "Fitur potong gambar AI di Alatify menjalankan jaringan saraf yang sangat dioptimalkan langsung di browser kamu menggunakan ONNX runtime WebAssembly.",
      "modelNotice": "Model GPU bakal lebih cepat di perangkat yang mendukung. Model Lite (CPU) paling pas buat perangkat tanpa akselerasi GPU.",
      "runtimeNotice": "Saat pertama kali dipakai, browser akan mengunduh runtime AI (~33 MB) sekali saja. Setelah itu, semuanya disimpan di cache offline agar bisa langsung dimuat secara instan di pemakaian berikutnya."
    },
    "blur": {
      "intro": "Sensor wajah, pelat nomor, dan info sensitif dengan aman langsung di browser kamu. Seret kotak merah atau usap kuas untuk menghapus permanen bagian sensitifnya secara offline.",
      "howItWorks": {
        "step1": "Masukkan gambarmu lewat seret-lepas, tombol pemilih file, atau ambil dari URL aman.",
        "step2": "Pilih mode Box untuk pelat/teks, atau mode Brush untuk target alami seperti wajah.",
        "step3": "Gambar kotak atau sapukan kuas. Atur ukuran dan tingkat keburaman sesukamu.",
        "step4": "Klik Unduh. Alatify bakal menghapus permanen piksel asli di area itu dan membuang metadata EXIF."
      },
      "faq": {
      ...
      "autoDetectHelp": "⚡ Deteksi wajah lokal. Paling pas untuk wajah yang tegak dan jelas. Kamu masih bisa mengaturnya secara manual."
    },
    "converter": {
      ...
      "howItWorks": {
        "step1": "Masukkan satu atau banyak gambar (lewat seret-lepas atau pemilih file).",
        "step2": "Pilih format keluaran: JPG, PNG, WebP, ICO, SVG, TIFF, BMP, atau GIF.",
        "step3": "Proses semuanya sekaligus secara instan di perangkatmu.",
        "step4": "Simpan hasilnya satu per satu, atau unduh semua sekaligus sebagai ZIP."
      },
      "useCases": {
        "case1": "Perkecil gambar biar websitemu dimuat lebih cepat tanpa mengurangi kualitas gambar.",
        "case2": "Buat favicon untuk websitemu dengan format yang benar.",
        "case4": "Ubah gambar biasa menjadi grafis vektor SVG yang skalanya bisa dibesarkan.",
        "case5": "Ubah foto iPhone (HEIC) menjadi JPG yang kompatibel di semua perangkat."
      },
      "faq": {
      ...
      "svgTooLarge": "Gambar terlalu besar untuk diubah ke SVG (maksimal 1000 × 1000). Kecilkan dulu pakai alat Resizer kami, atau pilih format PNG/WebP untuk foto.",
      "alphaBackdropHelp": "Format tujuan pilihanmu tidak sepenuhnya menjamin transparansi asli. Isi piksel transparan dengan:",
      "combinePdfPointer": "Butuh menggabungkan banyak gambar jadi satu PDF?",
      "combinePdfPointerLink": "Pakai alat khusus PDF di sini →"
    },
    "cropper": {
      "intro": "Potong gambar ke rasio tetap atau atur bebas pakai pegangan sudut, lalu luruskan kemiringan dengan rotasi presisi. Semuanya terpantau lewat pratinjau real-time di browser kamu. Tanpa unggah, tanpa daftar akun. Fotomu tidak pernah meninggalkan perangkat.",
      "howItWorks": {
        "step1": "Letakkan gambarmu di sini. Gambarmu tetap tersimpan aman di perangkat.",
        "step2": "Seret sudut-sudutnya untuk memotong bebas, atau pilih rasio tetap seperti 1:1 atau 16:9.",
        "step3": "Putar gambarnya untuk merapikan sudut miring atau menyelaraskan objek.",
        "step4": "Simpan gambar hasil potonganmu."
      },
      "useCases": {
        "case1": "Potong gambar ke rasio pas yang biasa dipakai media sosial, seperti kotak 1:1, banner 16:9, atau ukuran story.",
        "case2": "Posisikan foto wajahmu dengan pas untuk foto profil atau avatar.",
        "case3": "Potong gambar secara fokus untuk thumbnail video atau artikel yang menarik perhatian.",
        "case4": "Buang bagian pinggir yang mengganggu atau luruskan garis horizon yang miring."
      },
      "faq": {
      ...
      "privacyNotice": "Alatify memproses file gambarmu sepenuhnya secara lokal menggunakan sandbox API di dalam tab browser kamu. Kami tidak pernah mengunggah file atau koordinat pribadimu ke server luar, sehingga 100% aman dari kebocoran data. Potong dan putar gambar secara instan dan privat di perangkatmu sendiri."
    },
    "exif-cleaner": {
      "intro": "Tiap foto dari HP membawa metadata EXIF tersembunyi, seperti lokasi GPS, model kamera, tanggal, dan detail HP yang ikut terkirim saat kamu berbagi file. Alatify menunjukkan data ini dengan jelas lalu menyapunya hingga bersih langsung di browser kamu. Prosesnya aman tanpa unggah file dan berjalan secara lossless, sehingga cuma metadatanya yang hilang tanpa mengurangi kualitas fotomu.",
      "howItWorks": {
        "step1": "Seret fotomu ke sini atau pilih file. File tetap aman di perangkatmu.",
        "step2": "Lihat semua metadata yang terbaca, lengkap dengan peringatan merah jika ada lokasi GPS.",
        "step3": "Bersihkan metadata secara lossless, tanpa kompresi ulang, tanpa merusak kualitas.",
        "step4": "Simpan hasil fotomu yang sudah bersih dari metadata, siap dibagikan dengan aman."
      },
      "useCases": {
        "case1": "Foto yang diambil di rumah biasanya menyimpan lokasi GPS. Hapus dulu sebelum kamu posting ke Facebook Marketplace, eBay, atau Tokopedia biar alamat rumahmu tidak tersebar.",
        "case2": "Foto liburan bisa membocorkan kalau kamu sedang tidak di rumah. Hapus lokasi dan stempel waktu sebelum kamu membagikannya.",
        "case3": "Lokasi GPS yang detail bisa memandu orang asing langsung ke alamatmu. Bersihkan dulu fotomu sebelum diunggah ke publik.",
        "case4": "Hapus metadata lokasi sebelum kamu mengirimkan karya ke klien atau memublikasikannya secara online."
      },
      "faq": {
      ...
      "alreadyCleanNotice": "Gambar ini sudah bersih. Tidak ada tag EXIF, GPS, kamera, atau software yang terdeteksi.",
      "coordinatesNotice": "Gambar ini mengungkap persis di mana foto diambil:"
    },
    "id-protector": {
      "intro": "Setiap hari, jutaan foto kartu identitas (KTP, SIM, paspor) dibagikan online secara bebas, yang rawan disalahgunakan untuk penipuan atau pinjol. ID Privacy Shield membantu kamu menyensor detail sensitif memakai kotak hitam permanen dan memasang watermark ubin agar identitasmu tidak bisa disalahgunakan. Semuanya berjalan 100% lokal di browser kamu. Dokumenmu tidak pernah dikirim ke server, dan file hasil unduhan otomatis bersih dari metadata tersembunyi.",
      "howItWorks": {
        "step1": "Masukkan KTP, SIM, paspor, atau foto identitasmu. File ini tidak pernah meninggalkan browser kamu.",
        "step2": "Gambar kotak sensor SOLID di atas info penting seperti nomor NIK/ID, tanda tangan, dan alamat.",
        "step3": "Tambahkan watermark ubin diagonal yang bertuliskan tujuan dan tanggal biar tidak disalahgunakan pihak lain.",
        "step4": "Unduh hasil PNG yang aman. Sensor menyatu dengan piksel gambar dan metadatanya dibuang bersih."
      },
      "useCases": {
        "case1": "Amankan foto KTP, SIM, atau paspor sebelum dikirim untuk syarat rental. Tambahkan watermark nama agen rental dan tanggalnya biar tidak bisa dipakai ulang.",
        "case2": "Sensor nomor penting dan tanda tangan sebelum mengirimkan kartu identitas ke platform kerja freelance atau portal verifikasi mitra.",
        "case3": "Hindari mengirim foto kartu identitas mentah tanpa pelindung lewat WhatsApp atau email untuk booking hotel atau kontrak kerja."
      },
      "faq": {
      ...
      "privacyNotice": "Alatify memproses file identitasmu sepenuhnya secara lokal menggunakan sandbox API di dalam tab browser kamu. Kami tidak pernah mengunggah dokumen atau koordinat pribadimu ke server luar, sehingga 100% aman dari kebocoran data. Sensor nomor identitas sensitif, pasang watermark ubin diagonal, dan bersihkan metadata EXIF GPS secara instan dan aman di perangkatmu sendiri sebelum dikirim.",
      "uploadInstructions": "Seret & taruh KTP, SIM, paspor, atau foto identitasmu di sini, atau klik untuk memilih file."
    },
    "qr-toolkit": {
      "intro": "Buat QR code statis secara offline yang aktif selamanya tanpa jebakan batas waktu dari pihak ketiga. Kamu juga bisa memindai QR code misterius dengan aman langsung di browser kamu untuk memeriksa tujuan aslinya, membuang link pelacak, dan melihat URL sebelum membukanya.",
      "howItWorks": {
        "step1": "Pilih mode URL, Teks, atau Wi-Fi, lalu isi detailnya. QR code langsung jadi secara offline.",
        "step2": "Atur ukuran, margin, warna kustom, dan tingkat koreksi sebelum mengunduh file PNG/SVG.",
        "step3": "Arahkan kamera atau masukkan gambar QR code. Proses dekode dijalankan lokal di browser kamu.",
        "step4": "Periksa domain tujuan, bersihkan parameter pelacak, dan lihat peringatan link pendek."
      },
      "faq": {
      ...
      "privacyNotice": "Alatify memproses QR code kamu sepenuhnya secara lokal menggunakan API client sandbox di dalam tab browser kamu. Kami tidak pernah mengunggah URL, teks, rekaman kamera, atau gambar yang kamu masukkan. Alat ini 100% offline dan bebas pelacakan, menjaga data pemindaian dan hasil QR code tetap aman di perangkatmu."
    },
    "resizer": {
      "intro": "Ubah ukuran gambar berdasarkan piksel, persentase, atau rasio aspek yang terkunci, semuanya langsung di browser kamu. Pencuplikan ulang berkualitas tinggi menjaga tepi gambar tetap tajam, dan kamu bisa memproses banyak gambar sekaligus. Tanpa unggah, tanpa daftar akun. Gambarmu tidak pernah keluar dari perangkat.",
      "howItWorks": {
        "step1": "Masukkan satu atau banyak gambar sekaligus.",
        "step2": "Isi piksel lebar/tinggi, atur persentase skala, atau kunci rasio aspek gambar.",
        "step3": "Ubah semua ukuran gambar sekaligus dengan teknologi resampling berkualitas tinggi.",
        "step4": "Simpan hasilnya satu per satu atau unduh semua dalam format ZIP."
      },
      "useCases": {
        "case1": "Mengubah ukuran gambar ke dimensi pas yang dibutuhkan platform media sosial, seperti postingan kotak, banner, story, atau foto profil.",
        "case2": "Mengecilkan resolusi foto yang terlalu besar biar lebih cepat dimuat di website dan lolos batas unggahan.",
        "case3": "Mengubah ukuran satu folder gambar ke dimensi yang sama sekaligus dalam sekali jalan.",
        "case4": "Mendapatkan ukuran piksel yang pas dan presisi untuk kebutuhan tata letak web atau desain."
      },
      "faq": {
      ...
      "cropBehaviorHelp": "Mengisi area ukuran baru sepenuhnya, memotong bagian tepi yang berlebih mulai dari tengah.",
      "fitBehaviorHelp": "Memuat seluruh gambar di dalam batas ukuran baru, menyisakan area kosong di samping atau atas dengan warna solid atau transparan."
    },
    "steganography": {
      "intro": "Amankan pesan rahasia kamu secara offline. Tanamkan pesan teks ke dalam gambar memakai metode Least Significant Bit (LSB), lengkap dengan opsi enkripsi AES-GCM menggunakan password. Hasil gambar akan terlihat sama persis tanpa ada perbedaan kasatmata. Semuanya berjalan langsung di sandbox browser kamu: bebas server, bebas bocor.",
      "howItWorks": {
        "step1": "Pilih gambar pembawa (carrier). Bagian transparan otomatis diratakan menjadi warna putih di memori.",
        "step2": "Ketik pesan rahasiamu. Memasukkan password otomatis memicu enkripsi AES-GCM 256-bit sebelum pesan ditanamkan.",
        "step3": "Bit biner dari data pesan akan menggantikan Least Significant Bits dari warna gambar RGB.",
        "step4": "Ekspor hasilnya wajib dalam format PNG. Ini biar piksel pesan di dalamnya tidak rusak oleh kompresi."
      },
      "faq": {
      ...
      "passwordHelp": "Mengunci dengan password akan membuat kunci enkripsi 256-bit untuk melindungi pesanmu. Tanpa password yang benar, pesan yang diekstrak cuma berupa kode acak yang tidak bisa dibaca."
    },
    "upscaler": {
      "intro": "Pertajam dan perbesar fotomu menggunakan kecerdasan buatan Real-ESRGAN yang berjalan langsung di browser kamu. Berjalan 100% di browser kamu, sehingga fotomu tidak pernah meninggalkan perangkat.",
      "howItWorks": {
        "step1": "Letakkan gambarmu di sini. Gambarmu tetap tersimpan aman di perangkat.",
        "step2": "Pilih 2x untuk proses cepat, atau 4x untuk detail yang paling tajam.",
        "step3": "AI lokal akan memproses gambar bagian demi bagian, didukung akselerasi GPU jika tersedia.",
        "step4": "Simpan hasil foto PNG kamu yang sudah lebih tajam dan beresolusi tinggi."
      },
      "useCases": {
        "case1": "Memperbesar foto lama atau buram tanpa merusak ketajaman atau detail aslinya.",
        "case2": "Mempertajam dan menaikkan resolusi foto produk agar terlihat bersih untuk dipasang di e-commerce.",
        "case3": "Menyiapkan gambar resolusi tinggi untuk kebutuhan cetak ukuran besar atau layar resolusi tinggi.",
        "case4": "Memperbaiki detail yang pecah pada gambar yang terkompresi berat atau ukurannya terlalu kecil.",
        "case5": "Meningkatkan resolusi hasil AI seperti Midjourney, DALL-E, atau Stable Diffusion untuk unduhan HD.",
        "case6": "Memperjelas hasil screenshot atau grafis untuk slide presentasi agar teksnya terbaca tajam."
      },
      "faq": {
    ...
    "watermark": {
      ...
      "howItWorks": {
        ...
        "step2": "Pilih watermark teks atau logo, lalu atur gayanya: ukuran, transparansi, warna, dan rotasi.",
        "step3": "Pasang di pojok, ubin menyebar, atau seret bebas ke bagian mana saja yang kamu mau.",
        "step4": "Simpan hasil gambarmu satu per satu atau unduh semua sekaligus sebagai ZIP."
      },
      "useCases": {
        "case1": "Mencegah pencurian gambar dan pemakaian tanpa izin dengan watermark yang terlihat jelas.",
        "case2": "Menempelkan logo atau username milikmu ke foto sebelum diposting atau dibagikan.",
        "case3": "Memasang watermark yang sama ke banyak foto sekaligus dalam satu proses cepat.",
        "case4": "Memasang watermark ubin diagonal biar gambarnya tidak bisa dicrop atau dipotong pihak lain."
      },
      "faq": {
      ...
      "privacyNotice": "Alatify memproses file gambarmu sepenuhnya secara lokal menggunakan sandbox API di dalam tab browser kamu. Kami tidak pernah mengunggah file atau koordinat pribadimu ke server luar, sehingga 100% aman dari kebocoran data. Pasang watermark dan amankan karyamu langsung di perangkatmu sendiri.",
      "previewResolutionNotice": "Resolusi pratinjau dibatasi hingga 1200px. Watermark asli akan diterapkan pada resolusi penuh saat diekspor."
    },
    "stock-finder": {
      "intro": "Cari foto di Unsplash, Pexels, dan Pixabay sekaligus. Menariknya, Alatify juga bisa mencari ilustrasi dan vektor, beda dari pencari stok biasa yang cuma menampilkan foto. Temukan gambar yang pas, lalu langsung buka di alat Alatify untuk hapus background, kompres, atau konversi. Semuanya gratis, tanpa daftar akun.",
      "howItWorks": {
        "step1": "Ketik kata kunci untuk mencari gambar gratis di Unsplash, Pexels, dan Pixabay sekaligus.",
        "step2": "Filter hasil pencarian berdasarkan tipe konten (foto, ilustrasi, atau vektor), sumber, dan orientasi.",
        "step3": "Pilih gambar yang kamu butuhkan.",
        "step4": "Buka gambar sekali klik di alat edit Alatify, atau unduh langsung ke perangkatmu."
      },
      "useCases": {
        "case1": "Mencari foto berkualitas tinggi dan bebas royalti untuk kebutuhan blog, artikel, atau postingan media sosial.",
        "case2": "Mendapatkan gambar ilustrasi atau vektor untuk bahan presentasi, desain, atau thumbnail, bukan sekadar foto biasa.",
        "case3": "Mencari gambar ukuran lebar beresolusi tinggi untuk background website atau header.",
        "case4": "Mengirim hasil pencarian langsung ke alat Alatify untuk dihapus background-nya, dikompres, atau dikonversi."
      },
      "faq": {
    ...
    "html-to-markdown": {
      "intro": "Ubah kode HTML atau file .html menjadi format Markdown yang bersih dan mudah dibaca langsung di browser kamu. Cukup tempel kodenya atau unggah file, lalu salin atau unduh hasilnya. Bebas server, tanpa akun, dan datamu tidak pernah keluar dari perangkat.",
      "howItWorks": {
        "step1": "Tempel kode HTML atau unggah file .html dari perangkatmu.",
        "step2": "Alat ini mengurai kode HTML secara lokal memakai library Turndown di dalam sandbox browser.",
        "step3": "Format judul, daftar, link, teks tebal/miring, kutipan, dan blok kode otomatis diubah ke Markdown.",
        "step4": "Salin hasil Markdown ke clipboard atau unduh sebagai file .md secara instan."
      },
      "useCases": {
        "subtitle": "Mengubah halaman web, hasil ekspor, atau potongan kode HTML menjadi draf Markdown yang siap diedit.",
        "case1": "Migrasi postingan blog, landing page, atau hasil ekspor CMS menjadi Markdown untuk static site generator.",
        "case2": "Mengubah halaman wiki internal, dokumentasi produk, atau artikel bantuan berbasis HTML menjadi file .md.",
        "case3": "Mengarsipkan newsletter atau email HTML secara lokal dan merapikannya menjadi teks Markdown yang bersih.",
        "case4": "Mengubah file halaman web yang disimpan menjadi catatan Markdown untuk Obsidian, Notion, atau GitHub."
      },
      "faq": {
      ...
      "privacyNotice": "Alatify memproses file HTML kamu sepenuhnya secara lokal menggunakan sandbox API di dalam tab browser kamu. Kami tidak pernah mengunggah kode atau konten pribadimu ke server luar, sehingga 100% aman dari kebocoran data. Konversi HTML ke Markdown secara aman langsung di perangkatmu sendiri.",
      "placeholder": "Tempel kode HTML atau unggah file .html untuk melihat hasil Markdown di sini.",
      "downloadMd": "Unduh .md"
    },
    "code-to-image": {
      "intro": "Ubah kodenmu menjadi gambar cantik yang siap dibagikan ke Twitter, blog, atau dokumentasi. Lengkap dengan tema developer dan font Geist Mono yang tajam. Atur gaya cuplikan kode, ekspor sebagai PNG/SVG, atau teruskan ke alat edit gambar lainnya.",
      "howItWorks": {
        "step1": "Tempel kode sumber kamu ke editor, atau klik contoh kode yang tersedia untuk mencoba.",
        "step2": "Shiki menyorot bahasamu secara lokal lewat deteksi otomatis atau pilihan manual dari dropdown.",
        "step3": "Pilih tema: Geist Monokrom, Dark, atau Light, lalu atur padding dan tampilan frame window.",
        "step4": "Unduh PNG/SVG, salin gambar ke clipboard, atau kirim ke compressor, resizer, converter, atau watermark."
      },
      "useCases": {
        "subtitle": "Membuat gambar cuplikan kode yang cantik untuk postingan media sosial, dokumentasi, dan presentasi.",
        "case1": "Membagikan kode dengan highlight cantik di Twitter developer, Mastodon, atau LinkedIn tanpa screenshot yang buram.",
        "case2": "Menambahkan blok kode yang rapi ke postingan blog, file README, dan dokumentasi teknis.",
        "case3": "Membuat visual slide presentasi atau gambar panduan dengan font monospace yang konsisten.",
        "case4": "Membuat gambar kode lalu mengirimkannya ke compressor atau converter biar file-nya lebih ringan."
      },
      "faq": {
      ...
      "privacyNotice": "Proses highlight dan ekspor gambar berjalan lokal di tab browser kamu memakai Shiki dan library modern-screenshot."
    },
    "markdown-to-pdf": {
      "intro": "Konversi file Markdown atau teks biasa menjadi dokumen PDF dengan tata letak rapi, semuanya diproses lokal di perangkatmu. Tanpa unggah server, tanpa konfigurasi ribet, dan tanpa perlu mendaftar. Catatan dan dokumen rahasiamu tidak pernah keluar dari perangkat.",
      "howItWorks": {
        "step1": "Tempel teks Markdown kamu ke editor, atau unggah file .md lokal.",
        "step2": "Lihat pratinjau hasil render secara langsung di panel samping dengan format otomatis.",
        "step3": "Buat PDF langsung di browser memakai render vektor biar teksnya tajam dan bisa diseleksi.",
        "step4": "Unduh dokumen PDF hasil akhir seketika. Sepenuhnya privat."
      },
      "useCases": {
        "case1": "Menyimpan panduan proyek, file readme markdown, atau catatan penting menjadi file PDF yang rapi.",
        "case2": "Membuat handout, ringkasan, atau panduan belajar yang mudah dibaca dari file teks biasa.",
        "case3": "Mencetak laporan, log kerja, atau catatan harian secara offline tanpa bergantung pada koneksi internet atau server.",
        "case4": "Menyusun catatan harian pribadi atau panduan tim secara privat tanpa risiko bocor ke internet."
      },
      "faq": {
      ...
      "privacyNotice": "Alatify memproses dokumen kamu sepenuhnya secara lokal menggunakan sandbox API di dalam tab browser kamu. Kami tidak pernah mengunggah file atau konten pribadimu ke server luar, sehingga 100% aman dari kebocoran data. Konversi Markdown ke PDF langsung di perangkatmu sendiri.",
      "downloadMd": ""
    },
    "pdf-to-markdown": {
      "intro": "Ekstrak teks dari file PDF dan ubah menjadi format Markdown yang rapi, semuanya berjalan langsung di browser kamu. Filemu tidak pernah meninggalkan perangkat.",
      "howItWorks": {
        "step1": "Pilih atau seret file PDF biasa yang memiliki lapisan teks (bisa diseleksi).",
        "step2": "Klik Convert to Markdown untuk menganalisis teks, baris, dan tata letak secara offline.",
        "step3": "Sistem otomatis menghitung ukuran font untuk memetakan level judul (heading) dan daftar.",
        "step4": "Lihat hasil Markdown, lalu copy kodenya atau unduh sebagai file .md."
      },
      "useCases": {
        "subtitle": "Mengubah jurnal, dokumen, dan transkrip menjadi format markup yang bersih dan siap diedit.",
        "case1": "Mengambil teks dari publikasi ilmiah atau jurnal untuk catatan di aplikasi seperti Obsidian.",
        "case2": "Mengubah panduan teks-tebal, ebook, atau laporan berlisensi terbuka menjadi Markdown untuk diedit kembali.",
        "case3": "Memproses invoice, kontrak, atau berkas rahasia secara lokal tanpa mengirim teks ke server pihak ketiga.",
        "case4": "Mengubah panduan belajar atau outline dokumen menjadi format catatan wiki yang rapi."
      },
      "faq": {
        "q1": "Apakah dokumenku diunggah ke server?",
      ...
      "privacyNotice": "Semua ekstraksi teks PDF dan penyusunan dokumen berjalan lokal di dalam sandbox browser kamu. Filemu tidak pernah dikirim ke server luar atau cloud lain untuk menjaga kerahasiaan penuh.",
      "placeholder": "Unggah dokumen dan klik \"Convert to Markdown\" untuk melihat hasilnya di sini.",
      "warningScanned": "Kami mendeteksi sedikit sekali teks di dokumen ini. Kemungkinan besar ini adalah PDF hasil scan atau gambar tanpa data teks. OCR offline tidak didukung.",
      "limitations": {
        "tables": "PDF tidak punya struktur tabel asli. Koordinat grid datar dan hasilnya akan berupa baris mendatar biasa.",
        "columns": "Urutan pembacaan teks berjalan lurus, sehingga teks di kolom ganda mungkin urutannya bertumpuk.",
        "scanned": "Tidak dilakukan OCR offline. Halaman hasil scan akan memicu banner peringatan."
      }
    },
    "pdf-pages": {
      "intro": "Masukkan satu atau banyak PDF, atur ulang urutan halamannya lewat seret-lepas, putar, atau buang halaman tertentu, lalu ekspor PDF baru, semuanya di browser kamu. Memasukkan banyak file otomatis menggabungkannya sesuai urutan. Tanpa unggah, tanpa akun, tanpa data keluar dari perangkatmu.",
      "howItWorks": {
        "step1": "Masukkan satu atau banyak file PDF. Halaman dari tiap file otomatis muncul dalam satu daftar berurutan.",
        "step2": "Seret baris untuk mengatur urutan halaman, putar halaman tertentu 90°, hapus yang tidak perlu, atau centang halaman untuk dipisah.",
        ...
        "step4": "Library pdf-lib menyalin objek halaman asli langsung ke file PDF baru tanpa rasterisasi, menjaga kualitas teks tetap tajam."
      },
      "useCases": {
        "subtitle": "Gabung, pisah, dan rapikan PDF tanpa software desktop atau unggah cloud.",
        "case1": "Menggabungkan invoice, kontrak, atau halaman hasil scan dari beberapa file terpisah menjadi satu dokumen yang rapi.",
        "case2": "Memilih beberapa halaman penting saja dari file PDF besar dan mengekspornya menjadi file PDF baru yang lebih ringan.",
        "case3": "Mengatur ulang urutan halaman yang terbalik akibat salah scan atau salah ekspor tanpa harus scan ulang.",
        "case4": "Memutar posisi halaman landscape atau miring menjadi tegak sebelum diekspor sebagai PDF akhir."
      },
      "faq": {
      ...
      "privacyNotice": "Setiap PDF yang kamu masukkan dibaca dan diproses lokal memakai library pdf-lib di browser kamu. File tidak pernah menyentuh server kami atau pihak ketiga. Begitu tab browser ditutup, dokumen otomatis terhapus dari memori.",
    ...
    "pdf-to-image": {
      "intro": "Ubah halaman PDF menjadi file gambar JPG atau PNG berkualitas tinggi langsung di browser kamu. Pilih halaman atau rentang tertentu, atur skala resolusi, lalu unduh halaman per halaman atau unduh sekaligus sebagai file ZIP. Tanpa unggah, tanpa daftar akun, 100% privat.",
      "howItWorks": {
        "step1": "Masukkan file PDF kamu lewat seret-lepas atau tombol pilih file.",
        "step2": "Pilih format PNG (disarankan jika butuh transparansi) atau JPG (background putih otomatis) dan atur skala render.",
        "step3": "Pilih semua halaman atau tentukan halaman mana saja yang mau kamu ubah jadi gambar.",
        "step4": "Klik Konversi dan unduh gambarmu atau unduh sekaligus dalam arsip ZIP."
      },
      "useCases": {
        "case1": "Mengubah slide presentasi atau halaman dokumen PDF menjadi gambar untuk dipajang di web atau media sosial.",
        "case2": "Mengambil foto, struk belanja, atau bagan penting dari file PDF sebagai file gambar terpisah yang bersih.",
        "case3": "Mengubah dokumen teks menjadi gambar agar bisa langsung dilihat tanpa butuh PDF reader.",
        "case4": "Mengonversi file laporan keuangan sensitif secara lokal di perangkatmu tanpa lewat server pihak ketiga."
      },
      "faq": {
      ...
      "privacyNotice": "Alatify memproses file PDF kamu sepenuhnya secara lokal menggunakan sandbox API di dalam tab browser kamu. Kami tidak pernah mengunggah file atau data pribadimu ke server luar, sehingga 100% aman dari kebocoran data.",
      "scaleStandard": "1x (Standar)",
      "scaleHigh": "2x (Tinggi)",
      "scaleMaximum": "3x (Maksimum)",
      "scaleHelper": "Skala lebih tinggi = gambar lebih tajam, tapi ukuran file jadi lebih besar dan prosesnya lebih lambat."
    },
    "image-to-pdf": {
      "intro": "Gabungkan banyak gambar JPG, PNG, atau WebP menjadi satu dokumen PDF yang terorganisir dengan rapi. Atur urutan halamannya lewat seret-lepas atau tombol Naik/Turun, sesuaikan ukuran kertas, margin, dan orientasi halaman, semuanya dihitung lokal di perangkatmu.",
      "howItWorks": {
        "step1": "Masukkan satu atau banyak gambar (seret-lepas atau pilih file sekaligus).",
        "step2": "Atur urutan halaman dengan menyeret thumbnail gambar atau pakai tombol Naik/Turun.",
        "step3": "Atur setelan halaman: ukuran kertas (A4, Letter, atau ikuti ukuran asli gambar), orientasi, dan margin.",
        "step4": "Ekspor dan unduh file PDF hasil kompilasimu seketika."
      },
      "useCases": {
        "case1": "Menggabungkan foto dokumen, struk belanja, atau sketsa hasil scan menjadi satu file PDF untuk syarat pengiriman atau arsip.",
        "case2": "Menyusun portofolio digital, album foto, atau slide presentasi dari file desain terpisah.",
        "case3": "Mengubah urutan foto menjadi dokumen PDF multi-halaman agar mudah dibaca berurutan.",
        "case4": "Menyusun dokumen penting, kontrak kerja, atau kartu identitas secara lokal dan privat tanpa risiko bocor ke internet."
      },
      "faq": {
      ...
      "privacyNotice": "Alatify menggabungkan gambarmu ke dalam PDF secara lokal menggunakan sandbox API di dalam tab browser kamu. Kami tidak pernah mengunggah file atau koordinat pribadimu ke server luar, sehingga 100% aman dari kebocoran data."
    },
    "status": {
      "available": "Tersedia"
    }
  ...
  "toolsPage": {
    "intro": "Koleksi pilihan alat gambar yang mengutamakan privasi dan berjalan sepenuhnya di browser kamu. Tanpa unggah, tanpa daftar akun, sepenuhnya privat. Mulai dari Background Remover dan Image Compressor hingga konversi format, pengubahan ukuran, dan lainnya, setiap alat memproses gambar Anda langsung di perangkat.",
    "backToHome": "Kembali ke beranda",
    "title": "Tools",
    "scrollExplore": "Gulir untuk menjelajah",
    "stockFinder": {
      "badge": "Belum punya gambar?",
      "description": "Mulai dari nol. Cari foto stok gratis lalu edit langsung dalam satu klik.",
      "button": "Cari Foto Stok"
    },
    "section": {
      "title": "Tools kami",
      "subtitle": "Setiap alat berjalan 100% di browser kamu, jadi tidak ada data yang keluar dari perangkatmu."
    }
  },
  "tools-image": {
    "intro": "Temukan berbagai alat edit, optimasi, dan konversi gambar yang mengutamakan privasi kamu. Semuanya berjalan aman di dalam sandbox browser kamu.",
    "nav": "Gambar"
  },
  "tools-document": {
    "intro": "Akses berbagai alat berbasis browser yang aman untuk menyusun halaman PDF, konversi Markdown, dan ekstraksi teks.",
    "nav": "Dokumen"
  },
  "tools-all": {
    "nav": "Semua"
  ...
  "footer": {
    "tagline": "Alat gambar yang mengutamakan privasi, berjalan sepenuhnya di browser kamu. Tanpa unggah ke server, privasimu benar-benar terjaga.",
  ...
  "imageUploader": {
    "error": {
      ...
      "unsupportedType": "Tipe file tidak didukung. Silakan unggah PNG, JPG, WebP, GIF, AVIF, BMP, HEIC, TIFF, atau SVG.",
    ...
    "dragAndDropMultiple": "Seret dan taruh gambar di sini, atau klik untuk memilih",
    "dragAndDropSingle": "Seret dan taruh gambar di sini, atau klik untuk memilih",
  ...
  "processingOverlay": {
    "default": {
      ...
      "description": "Biasanya makan waktu 30-60 detik. Jangan tutup tab ini dulu, ya."
    },
    "downloading": {
      "title": "Mengunduh model AI (cuma sekali di awal)…",
      "description": "Mengunduh model AI {modelSize}. File ini disimpan di perangkatmu, jadi proses berikutnya langsung cepat."
    },
    "initializing": {
    ...
    "processing": {
      "description": "Menjalankan ekstraksi subjek langsung di hardware perangkatmu."
    },
  ...
  "landing": {
    ...
    "cta": {
      ...
      "subtitle": "Proses gambarmu dengan aman dan cepat. Tanpa unggah, tanpa batasan, tanpa jebakan."
    }
  },
  "hintBubble": {
