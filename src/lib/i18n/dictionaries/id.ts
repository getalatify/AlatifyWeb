export const id = {
  home: {
    hero: {
      tagline:
        "Alat pemrosesan gambar yang mengutamakan privasi, berjalan sepenuhnya di browser Anda",
    },
    features: {
      card1: {
  ...
  about: {
    ...
    road: {
      ...
      p2_start:
        "Umpan balik Anda sangat berharga. Jika Anda memiliki saran, permintaan fitur, atau bug untuk dilaporkan, hubungi kami di",
      p2_end: ".",
    },
  },
  privacy: {
    short:
      "Alatify tidak mengumpulkan, menyimpan, atau mengirimkan gambar atau data pribadi Anda. Semua pemrosesan terjadi sepenuhnya di browser Anda. Tidak ada pendaftaran akun, tidak ada pelacakan pengguna, dan tidak ada analitik pihak ketiga.",
    collect: {
    ...
    contact: {
      start:
        "Punya pertanyaan tentang arsitektur lokal-pertama kami? Hubungi kami di",
      end: "",
    },
  },
  terms: {
    short:
      'Gunakan Alatify secara bebas untuk keperluan pribadi maupun komersial. Kami menyediakan alat berbasis browser ini "apa adanya" tanpa jaminan. Anda tetap bertanggung jawab penuh atas gambar yang Anda proses, dan Anda tidak boleh menggunakan Alatify untuk menangani konten ilegal.',
    license: {
    ...
    changes:
      "Ketentuan ini dapat berubah sewaktu-waktu secara berkala. Ketentuan layanan terbaru dan yang mengatur akan selalu dapat diakses di halaman ini. Penggunaan berkelanjutan Anda atas Alatify setelah perubahan diterapkan merupakan bentuk penerimaan terhadap ketentuan yang diperbarui tersebut.",
    contact: {
  ...
  shared: {
    ...
    related: {
      ...
      "exif-cleaner-info":
        "Hapus info lokasi dan kamera dari foto secara lokal.",
      ...
      "compressor-savings":
        "Kecilkan ukuran file hingga 90% tanpa mengorbankan kualitas.",
      "compressor-offline":
        "Kecilkan ukuran file gambar hingga 90% secara offline.",
      "resizer-dimensions":
        "Ubah dimensi gambar berdasarkan persentase atau piksel.",
      "resizer-pixels": "Ubah dimensi berdasarkan piksel, rasio, atau persen.",
      "converter-formats":
        "Konversi file antara JPG, PNG, WebP, PDF, dan vektor.",
      "converter-instantly":
        "Konversi antara PNG, JPEG, dan WebP secara instan.",
  ...
  tools: {
    compressor: {
      intro:
        "Kurangi ukuran file gambar dengan kontrol penuh. Pilih kompresi lossy untuk ukuran file terkecil, atau lossless untuk mempertahankan setiap piksel — berjalan sepenuhnya di browser Anda tanpa perlu unggah.",
      hintBubble:
        "Tip: untuk file paling kecil, ekspor foto sebagai JPEG. Pilih PNG kalau butuh transparansi.",
      alreadyOptimised:
        "Sudah optimal — file ini tidak dapat diperkecil lebih jauh.",
      losslessConvertDisabled:
        "Lossless hanya tersedia saat mengompres ulang PNG asli.",
      pngLargerNudge:
        "Konversi ke PNG membuat file ini lebih besar. Untuk ukuran lebih kecil, coba WebP atau JPEG.",
      howItWorks: {
        ...
        step4:
          "Simpan file yang lebih kecil secara individual atau sebagai ZIP.",
      },
      useCases: {
        case1:
          "Gambar yang lebih kecil dimuat lebih cepat serta meningkatkan kecepatan halaman dan SEO.",
        case2:
          "Dapatkan ukuran di bawah batas lampiran dan unggahan tanpa kehilangan kualitas.",
        case3:
          "Kosongkan ruang penyimpanan dengan memperkecil pustaka foto yang besar.",
        case4:
          "Penuhi persyaratan ukuran platform sekaligus menjaga gambar tetap tajam.",
      },
      faq: {
    ...
    "bg-remover": {
      ...
      intro:
        "Sebagian besar penghapus latar belakang gratis mengunggah gambar Anda ke server mereka — dan banyak yang diam-diam menggunakannya untuk melatih AI mereka atau membatasi unduhan gratis pada resolusi rendah. Alatify berjalan sepenuhnya di browser Anda menggunakan AI di perangkat yang diakselerasi GPU. Foto Anda tidak pernah meninggalkan perangkat Anda. Tanpa pendaftaran, tanpa watermark, tanpa batas resolusi, dan tanpa batasan jumlah yang Anda proses — kualitas penuh, sepenuhnya privat, tanpa batas.",
      howItWorks: {
        step1: "Letakkan gambar Anda. Gambar tetap berada di perangkat Anda.",
        step2:
          "AI di perangkat mendeteksi subjek dan menghapus latar belakang, diakselerasi GPU, dalam hitungan detik.",
        step3:
          "Dapatkan potongan bersih dengan latar belakang transparan, pada resolusi penuh.",
        step4: "Simpan PNG transparan Anda. Tanpa watermark, tanpa batasan.",
      },
      useCases: {
        case1:
          "Foto produk dengan latar belakang transparan atau putih yang bersih untuk daftar Amazon, Etsy, Shopify, dan eBay.",
        case2:
          "Isolasi diri Anda untuk foto profesional atau LinkedIn yang bersih.",
        case3:
          "Potong logo, objek, atau orang untuk dimasukkan ke dalam desain, slide, dan thumbnail.",
        case4:
          "Tempatkan subjek Anda di latar belakang apa pun untuk postingan, cerita, dan grafis.",
      },
      faq: {
      ...
      privacyNotice:
        "Alatify menghapus latar belakang gambar seluruhnya di dalam tab browser Anda menggunakan AI di perangkat yang diakselerasi GPU. Foto Anda tidak pernah diunggah ke server, tidak pernah digunakan untuk melatih model, dan tidak pernah dicatat — membuat alat ini 100% kebal terhadap kebocoran atau retensi data di sisi server. Dapatkan PNG transparan resolusi penuh yang bebas watermark tanpa batas, diproses secara privat di perangkat Anda sendiri.",
      onnxNotice:
        "Ekstraksi latar AI Alatify menjalankan jaringan saraf yang sangat dioptimalkan di sandbox browser Anda menggunakan ONNX runtime WebAssembly.",
      modelNotice:
        "Model GPU lebih cepat di perangkat yang didukung; model Lite (CPU) paling cocok untuk perangkat tanpa akselerasi GPU.",
      runtimeNotice:
        "Penggunaan pertama juga akan mengunduh runtime AI (~33 MB) sekali. Setelah itu semuanya disimpan di cache offline — penggunaan berikutnya akan dimuat secara instan.",
    },
    blur: {
      intro:
        "Kaburkan wajah, pelat nomor, dan kredensial sensitif secara aman di browser web Anda. Seret kotak persegi panjang atau gambar sapuan kuas bebas untuk menghancurkan data piksel sensitif secara offline sepenuhnya.",
      howItWorks: {
        step1:
          "Unggah gambar Anda melalui seret-lepas, dialog file, atau unduh dari URL yang aman.",
        step2:
          "Pilih mode Box untuk pelat/teks, atau mode Brush untuk target organik seperti wajah.",
        step3:
          "Gambar persegi panjang atau lukis jalur. Sesuaikan ukuran dan intensitas keburaman secara dinamis.",
        step4:
          "Klik Unduh. Alatify menghancurkan data piksel yang mendasarinya dan menghapus metadata EXIF.",
      },
      faq: {
      ...
      autoDetectHelp:
        "⚡ Deteksi wajah lokal. Bekerja paling baik pada wajah yang jelas dan menghadap depan. Penyesuaian manual tersedia.",
    },
    converter: {
      intro:
      ...
      howItWorks: {
        step1:
          "Tambahkan satu atau banyak gambar (seret-lepas atau pemilih file).",
        step2:
          "Pilih output Anda: JPG, PNG, WebP, ICO, SVG, TIFF, BMP, atau GIF.",
      ...
      useCases: {
        case1:
          "Perkecil gambar untuk situs web yang memuat lebih cepat tanpa kehilangan kualitas.",
        case2: "Buat favicon untuk situs web Anda dalam format yang benar.",
        case4:
          "Lacak gambar raster menjadi grafik vektor yang dapat diskalakan.",
        case5:
          "Konversi foto iPhone menjadi JPG yang kompatibel secara universal.",
      },
      faq: {
      ...
      svgTooLarge:
        "Gambar terlalu besar untuk tracing SVG (maks. 1000 × 1000 didukung). Ubah ukuran gambar terlebih dahulu dengan alat Resizer kami, atau gunakan PNG/WebP untuk foto.",
      alphaBackdropHelp:
        "Format target yang dipilih tidak sepenuhnya menjamin rendering alpha channel native. Isi piksel transparan:",
      combinePdfPointer: "Butuh menggabungkan beberapa gambar menjadi PDF?",
      combinePdfPointerLink: "Gunakan alat khusus kami →",
    },
    cropper: {
      intro:
        "Potong ke rasio tetap atau secara bebas dengan pegangan yang dapat diseret, lalu luruskan dengan rotasi presisi — semuanya dengan pratinjau real-time di browser Anda. Tanpa unggah, tanpa pendaftaran — foto Anda tidak pernah meninggalkan perangkat Anda.",
      howItWorks: {
        step1: "Letakkan gambar Anda. Gambar tetap berada di perangkat Anda.",
        step2:
          "Seret pegangan untuk pemotongan bebas, atau pilih rasio tetap seperti 1:1 atau 16:9.",
        step3:
          "Putar untuk meratakan foto yang miring atau menyelaraskan subjek Anda.",
        step4: "Simpan gambar hasil potongan Anda.",
      },
      useCases: {
        case1:
          "Potong ke rasio tepat yang digunakan platform — kotak 1:1, spanduk 16:9, ukuran cerita.",
        case2:
          "Bingkai foto wajah Anda dengan sempurna untuk profil atau avatar apa pun.",
        case3:
          "Potong thumbnail yang ketat dan menarik perhatian untuk video dan artikel.",
        case4:
          "Pangkas tepi yang mengganggu atau luruskan cakrawala yang miring.",
      },
      faq: {
    ...
    "exif-cleaner": {
      ...
      howItWorks: {
        step1:
          "Seret dan letakkan foto Anda, atau pilih file. File tetap berada di perangkat Anda.",
        step2:
          "Lihat semua metadata yang terdeteksi, dengan peringatan menonjol jika lokasi GPS ada.",
        step3:
          "Hapus metadata secara lossless. Tanpa kompresi ulang, tanpa kehilangan kualitas.",
        step4:
          "Simpan salinan bersih dengan nol metadata, siap dibagikan dengan aman.",
      },
      useCases: {
        case1:
          "Foto yang diambil di rumah menyematkan lokasi GPS Anda. Hapus sebelum memposting ke Facebook Marketplace, eBay, atau Craigslist sehingga daftar tidak dapat mengungkapkan alamat Anda.",
        case2:
          "Foto liburan dapat menyiarkan bahwa Anda sedang jauh dari rumah. Hapus lokasi dan stempel waktu sebelum memposting.",
        case3:
          "Koordinat GPS yang tepat dapat mengarahkan orang asing ke pintu Anda. Bersihkan foto Anda sebelum membagikannya secara publik.",
        case4:
          "Hapus data lokasi sebelum mengirimkan ke klien atau menerbitkannya secara online.",
      },
      faq: {
      ...
      alreadyCleanNotice:
        "Gambar ini sudah bersih. Tidak ada tag EXIF, GPS, kamera, atau perangkat lunak yang terdeteksi.",
      coordinatesNotice: "Gambar ini mengungkap persis di mana foto diambil:",
    },
    "id-protector": {
      intro:
        "Setiap hari, jutaan foto ID mentah (KTP, SIM, paspor) dibagikan secara online, mengekspos mereka terhadap pencurian identitas dan penipuan. ID Privacy Shield memungkinkan Anda menyensor detail sensitif dengan blok padat yang tidak dapat dibalik dan menerapkan watermark ubin untuk menegakkan konteks penggunaan tertentu. Semuanya berjalan 100% secara lokal di browser Anda: dokumen Anda tidak pernah menyentuh server, dan file yang diunduh secara otomatis menghapus semua metadata tersembunyi.",
      howItWorks: {
        step1:
          "Pilih KTP, SIM, paspor, atau foto ID Anda. Dokumen Anda tidak pernah meninggalkan browser Anda.",
        step2:
          "Gambar kotak sensor SOLID di atas bidang sensitif seperti nomor NIK/ID, tanda tangan, dan alamat.",
        step3:
          "Tambahkan watermark ubin diagonal yang menyatakan tujuan dan tanggal untuk mencegah penggunaan kembali tanpa izin.",
        step4:
          "Simpan PNG yang dilindungi secara langsung. Sensor ditanamkan langsung ke dalam piksel dan metadata dihapus.",
      },
      useCases: {
        case1:
          "Amankan salinan KTP, SIM, atau paspor Anda sebelum mengirimkannya ke penyedia rental. Tambahkan watermark yang berisi nama agensi rental dan tanggal untuk menghindari penggunaan kembali.",
        case2:
          "Sensor nomor non-esensial dan blok tanda tangan sebelum mengirimkan ID Anda ke platform gig atau portal verifikasi pasar freelance.",
        case3:
          "Hindari mengirim foto ID mentah yang tidak dilindungi melalui WhatsApp atau email untuk reservasi hotel, kontrak freelance, atau pendaftaran layanan.",
      },
      faq: {
      ...
      privacyNotice:
        "Alatify memproses file ID Anda sepenuhnya secara lokal menggunakan sandbox APIs di dalam tab browser Anda. Kami tidak pernah mengunggah dokumen atau koordinat privat Anda ke cloud eksternal, membuat alat ini 100% kebal terhadap kebocoran atau pencatatan di sisi server. Sensor nomor identitas sensitif, lapisi watermark ubin diagonal, dan hapus metadata EXIF GPS/kamera secara instan dan aman di perangkat Anda sendiri sebelum didistribusikan.",
      uploadInstructions:
        "Seret & lepas KTP, SIM, paspor, atau foto identitas Anda di sini, atau klik untuk menelusuri.",
    },
    "qr-toolkit": {
      intro:
        "Buat QR codes statis sepenuhnya offline yang menjadi milik Anda selamanya tanpa jebakan kedaluwarsa dinamis. Pindai QR codes yang tidak dikenal dan audit titik akhirnya secara aman di dalam tab browser Anda: hapus parameter pelacakan dan analisis URL sebelum membukanya.",
      howItWorks: {
        step1:
          "Pilih mode URL, Teks, atau Wi-Fi. Ketik detailnya. QR di-render segera secara offline.",
        step2:
          "Sesuaikan ukuran, margin, warna kustom, dan koreksi kesalahan sebelum mengunduh PNG/SVG.",
        step3:
          "Arahkan kamera Anda atau letakkan gambar. Dekode dieksekusi secara lokal di dalam browser Anda.",
        step4:
          "Verifikasi domain target, bersihkan parameter pelacakan, dan tinjau peringatan pada jalur yang dipersingkat.",
      },
      faq: {
      ...
      privacyNotice:
        "Alatify memproses QR codes Anda sepenuhnya secara lokal menggunakan sandboxed client APIs di dalam tab browser Anda. Kami tidak pernah mengunggah URL, konten teks biasa, umpan kamera, atau file grafis yang diunggah. Alat ini 100% offline dan bebas telemetri, menjaga semua tujuan yang dipindai dan payload yang dihasilkan sepenuhnya privat di perangkat Anda.",
    },
    resizer: {
      intro:
        "Ubah ukuran gambar berdasarkan piksel yang tepat, berdasarkan persentase, atau dengan rasio aspek terkunci — semuanya di browser Anda. Pencuplikan ulang berkualitas tinggi menjaga tepi tetap tajam, dan Anda dapat mengubah ukuran seluruh kumpulan sekaligus. Tanpa unggah, tanpa pendaftaran — gambar Anda tidak pernah meninggalkan perangkat Anda.",
      howItWorks: {
        step1: "Tambahkan satu atau banyak gambar.",
        step2:
          "Masukkan piksel yang tepat, skala berdasarkan persentase, atau kunci rasio aspek.",
        step3:
          "Terapkan ke semua gambar sekaligus dengan pencuplikan ulang berkualitas tinggi.",
        step4: "Simpan satu per satu atau sebagai ZIP.",
      },
      useCases: {
        case1:
          "Ubah ukuran ke dimensi tepat yang diharapkan platform — postingan persegi, cerita, spanduk, dan foto profil.",
        case2:
          "Perkecil foto yang terlalu besar agar memuat lebih cepat dan sesuai dengan batas unggahan.",
        case3:
          "Ubah ukuran seluruh folder gambar ke dimensi yang sama dalam sekali jalan.",
      ...
      cropBehaviorHelp:
        "Mengisi ukuran preset sepenuhnya, memangkas dimensi berlebih dari bagian tengah.",
      fitBehaviorHelp:
        "Memuat seluruh gambar di dalam batas preset, menambahkan padding dengan latar transparan atau solid.",
    },
    steganography: {
      intro:
        "Lindungi komunikasi Anda secara offline. Tanamkan teks privat ke dalam gambar melalui steganografi Least Significant Bit (LSB), dengan enkripsi kata sandi AES-GCM opsional. File tetap terlihat identik di mata telanjang. Semuanya berjalan sepenuhnya di dalam sandbox browser Anda: tanpa server, tanpa kebocoran.",
      howItWorks: {
        step1:
          "Pilih gambar inang pembawa. Lapisan transparan diratakan menjadi putih solid di dalam memori.",
        step2:
          "Ketik pesan rahasia. Memasukkan kata sandi akan memicu enkripsi AES-GCM 256-bit sebelum dikemas.",
        step3:
          "Bit biner dari payload yang dikemas menggantikan Least Significant Bits dari saluran gambar RGB.",
        step4:
          "Ekspor hanya sebagai format PNG. Ini menjamin bahwa algoritma kompresi tidak mengubah piksel LSB.",
      },
      faq: {
      ...
      passwordHelp:
        "Mengunci dengan kata sandi menurunkan kunci 256-bit untuk mengenkripsi pesan Anda. Mengekstrak tanpa kata sandi yang benar menghasilkan ciphertext yang tidak terbaca.",
    },
    upscaler: {
      intro:
        "Pertajam dan perbesar foto Anda dengan jaringan saraf Real-ESRGAN yang berjalan sepenuhnya di browser Anda. Berjalan 100% di browser Anda — gambar Anda tidak pernah meninggalkan perangkat Anda.",
      howItWorks: {
        step1: "Letakkan gambar Anda. Gambar tetap berada di perangkat Anda.",
        step2: "Pilih 2x untuk kecepatan atau 4x untuk detail maksimum.",
        step3:
          "AI di perangkat menyempurnakan gambar ubin demi ubin, diakselerasi GPU jika didukung.",
        step4: "Simpan PNG Anda yang lebih tajam dan beresolusi lebih tinggi.",
      },
      useCases: {
        case1:
          "Perbesar foto lama atau beresolusi rendah tanpa kehilangan ketajaman atau detail.",
        case2:
          "Pertajam dan tingkatkan ukuran gambar produk untuk daftar Amazon, Shopify, atau Etsy yang bersih.",
        case3:
          "Siapkan gambar untuk pencetakan fisik format besar atau tampilan DPI tinggi.",
        case4:
          "Pulihkan detail dan perbaiki artefak pada grafik yang dikompresi berat atau diperkecil.",
        case5:
          "Tingkatkan ukuran output Midjourney, DALL-E, atau Stable Diffusion untuk unduhan resolusi tinggi.",
        case6:
          "Sempurnakan tangkapan layar dan grafik untuk presentasi dan slide deck.",
      },
      faq: {
    ...
    watermark: {
      ...
      howItWorks: {
        ...
        step2:
          "Pilih watermark teks atau logo dan atur gayanya: ukuran, opasitas, warna, rotasi.",
        step3:
          "Jepret ke sudut, ubin di seluruh gambar, atau seret ke mana pun Anda suka.",
        step4:
          "Simpan gambar ber-watermark Anda secara individual atau sebagai ZIP.",
      },
      useCases: {
        case1:
          "Cegah pencurian gambar dan penggunaan kembali tanpa izin dengan watermark yang terlihat.",
        case2:
          "Tambahkan logo atau handle Anda ke foto sebelum memposting atau membagikannya.",
        case3:
          "Terapkan watermark yang sama ke seluruh kumpulan sekaligus dalam satu langkah.",
        case4:
          "Ulangi watermark secara diagonal sehingga tidak dapat dipotong begitu saja.",
      },
      faq: {
      ...
      previewResolutionNotice:
        "Resolusi pratinjau dibatasi hingga 1200px. Watermark diterapkan pada resolusi penuh saat ekspor.",
    },
    "stock-finder": {
      intro:
        "Cari di Unsplash, Pexels, dan Pixabay sekaligus — dan tidak seperti kebanyakan pencari stok yang hanya menampilkan foto, Alatify juga menampilkan ilustrasi dan vektor. Temukan gambar yang pas, lalu langsung buka di alat edit Alatify untuk menghapus latarnya, mengompresnya, atau mengonversinya — semuanya gratis, tanpa daftar akun.",
      howItWorks: {
        step1:
          "Ketik kata kunci untuk mencari stok gratis di Unsplash, Pexels, dan Pixabay sekaligus.",
        step2:
          "Persempit berdasarkan jenis konten (foto, ilustrasi, atau vektor), sumber, dan orientasi.",
        step3: "Pilih gambar yang Anda inginkan.",
        step4: "Buka dengan satu klik di alat Alatify, atau unduh langsung.",
      },
      useCases: {
        case1:
          "Fotografi berkualitas tinggi dan bebas royalti untuk blog, artikel, dan postingan media sosial.",
        case2:
          "Grafik yang dapat diskalakan untuk presentasi, desain, dan thumbnail — bukan sekadar foto.",
        case3: "Gambar lebar beresolusi tinggi untuk situs web dan header.",
        case4:
          "Kirim hasil mana pun langsung ke Alatify untuk menghapus latar, mengompres, atau mengonversi.",
      },
      faq: {
    ...
    "html-to-markdown": {
      intro:
        "Konversi kode sumber HTML atau file .html menjadi Markdown yang bersih dan mudah dibaca — sepenuhnya di browser Anda. Tempel markup atau unggah file, lalu salin atau unduh hasilnya. Tanpa unggah server, tanpa akun, dan konten Anda tidak pernah meninggalkan perangkat.",
      howItWorks: {
        step1:
          "Tempel HTML ke editor atau unggah file .html lokal dari perangkat Anda.",
        step2:
          "Konverter mengurai markup Anda secara lokal menggunakan Turndown di dalam sandbox browser.",
        step3:
          "Heading, daftar, tautan, tebal/miring, blockquote, dan blok kode dipetakan ke Markdown.",
        step4:
          "Salin output ke clipboard atau unduh sebagai file .md secara instan.",
      },
      useCases: {
        subtitle:
          "Ubah halaman web, ekspor, dan cuplikan HTML menjadi draf Markdown yang dapat diedit.",
        case1:
          "Migrasikan posting blog, landing page, atau ekspor CMS ke Markdown untuk static site generator.",
        case2:
          "Konversi halaman wiki internal, dokumen bantuan, atau basis pengetahuan HTML menjadi file .md portabel.",
        case3:
          "Arsipkan HTML newsletter atau email secara lokal dan format ulang menjadi Markdown berbasis teks.",
        case4:
          "Ubah sumber halaman web tersimpan menjadi catatan Markdown untuk Obsidian, Notion, atau GitHub.",
      },
      faq: {
      ...
      privacyNotice:
        "Alatify memproses file HTML Anda sepenuhnya secara lokal menggunakan sandbox APIs di dalam tab browser Anda. Kami tidak pernah mengunggah kode sumber atau konten pribadi Anda ke cloud eksternal, membuat alat ini 100% kebal terhadap kebocoran atau pencatatan di sisi server. Konversi HTML ke Markdown secara aman langsung di perangkat Anda sendiri.",
      placeholder:
        "Tempel HTML atau unggah file .html untuk melihat output Markdown yang dikonversi di sini.",
      downloadMd: "Unduh .md",
    },
    "code-to-image": {
      intro:
        "Ubah kode Anda menjadi gambar siap bagikan untuk Twitter, blog, dan dokumentasi — dengan tema untuk developer dan tipografi Geist Mono yang tajam. Gaya cuplikan kode, ekspor PNG atau SVG, dan lanjutkan ke alat gambar lainnya.",
      howItWorks: {
        step1:
          "Tempel kode sumber ke editor, atau muat contoh cuplikan untuk memulai.",
        step2:
          "Shiki menyorot kode Anda secara lokal dengan deteksi bahasa otomatis atau override manual.",
        step3:
          "Pilih tema — Geist Monokrom, Dark, atau Light — dan aktifkan window chrome serta padding.",
        step4:
          "Unduh PNG atau SVG, salin ke clipboard, atau lanjutkan ke compressor, resizer, converter, atau watermark.",
      },
      useCases: {
        subtitle:
          "Buat visual kode yang indah untuk posting sosial, dokumentasi, dan presentasi.",
        case1:
          "Bagikan cuplikan kode dengan syntax highlight di dev Twitter, Mastodon, atau LinkedIn tanpa screenshot buram.",
        case2:
          "Tambahkan blok kode yang rapi ke posting blog, README, dan dokumentasi teknis.",
        case3:
          "Buat visual slide konferensi dan grafik tutorial dengan tipografi monospace yang konsisten.",
        case4:
          "Hasilkan gambar kode dan lanjutkan ke compressor atau converter untuk pengiriman yang dioptimalkan.",
      },
      faq: {
      ...
      privacyNotice:
        "Penyorotan dan ekspor gambar berjalan secara lokal di tab browser Anda menggunakan Shiki dan modern-screenshot.",
    },
    "markdown-to-pdf": {
      intro:
        "Konversi file Markdown atau teks biasa menjadi dokumen PDF dengan format indah yang diproses sepenuhnya secara lokal. Tanpa unggah server, tanpa konfigurasi, dan tanpa registrasi. Catatan dan dokumentasi pribadi Anda tidak pernah meninggalkan perangkat Anda.",
      howItWorks: {
        step1:
          "Tempel atau ketik Markdown Anda ke dalam editor, atau unggah file .md lokal.",
        step2:
          "Pratinjau tata letak yang dirender secara langsung di panel samping dengan pemformatan otomatis.",
        step3:
          "Buat PDF di sisi klien menggunakan rendering vektor untuk teks yang tajam dan dapat dipilih.",
        step4:
          "Unduh dokumen yang telah selesai secara instan. Sepenuhnya privat.",
      },
      useCases: {
        case1:
          "Simpan file readme markdown, panduan proyek, atau catatan perangkat lunak dengan cepat sebagai PDF yang mudah dibaca.",
        case2:
          "Buat selebaran, catatan, dan panduan belajar yang mudah dibaca dari file teks.",
        case3:
          "Cetak laporan dan log berformat bersih secara offline tanpa ketergantungan server.",
        case4:
          "Simpan catatan harian pribadi, wiki, atau panduan internal secara privat tanpa risiko kebocoran data.",
      },
      faq: {
      ...
      privacyNotice:
        "Alatify memproses file dokumen Anda sepenuhnya secara lokal menggunakan sandbox APIs di dalam tab browser Anda. Kami tidak pernah mengunggah file atau koordinat privat Anda ke cloud eksternal, membuat alat ini 100% kebal terhadap kebocoran atau pencatatan di sisi server. Format dan kompilasi Markdown ke PDF secara aman langsung di perangkat Anda sendiri.",
      downloadMd: "",
    },
    "pdf-to-markdown": {
      intro:
        "Ekstrak lapisan teks dari dokumen PDF dan ubah menjadi Markdown yang mudah dibaca — sepenuhnya di browser Anda. File Anda tidak pernah meninggalkan perangkat.",
      howItWorks: {
        step1:
          "Pilih atau seret dokumen PDF standar yang memiliki lapisan teks dapat dipilih.",
        step2:
          "Klik Convert to Markdown untuk menganalisis string teks, struktur tata letak, dan baris secara offline sepenuhnya.",
        step3:
          "Hitung ukuran font dominan untuk memetakan tingkat heading dan daftar secara otomatis.",
        step4:
          "Tinjau hasil Markdown yang sudah diformat, lalu salin teks atau unduh file .md-nya.",
      },
      useCases: {
        subtitle:
          "Ubah bahan bacaan, makalah, dan transkrip menjadi format markup yang bersih.",
        case1:
          "Pulihkan teks polos dari publikasi ilmiah atau jurnal dan formatkan menjadi Markdown untuk aplikasi catatan.",
        case2:
          "Ubah panduan teks-tebal, makalah teknis, atau ebook berlisensi terbuka menjadi draf Markdown yang siap diedit.",
        case3:
          "Proses faktur, kontrak, atau catatan sensitif secara lokal dan rahasia, tanpa mengirim teks ke server pihak ketiga.",
        case4:
          "Ubah panduan belajar, laporan outline, dan dokumen referensi menjadi catatan wiki yang rapi dan terformat.",
      },
      faq: {
        q1: "Apakah dokumen saya diunggah ke server?",
      ...
      privacyNotice:
        "Semua ekstraksi teks PDF dan kompilasi dokumen dilakukan sepenuhnya di dalam sandbox browser lokal Anda. Tidak ada file yang pernah dikirim ke server atau penyedia cloud eksternal, menjaga kerahasiaan dan privasi mutlak.",
      placeholder:
        'Unggah dokumen dan pilih "Convert to Markdown" untuk melihat hasil yang sudah diformat di sini.',
      warningScanned:
        "Kami mendeteksi sedikit atau tidak ada teks yang dapat dipilih di dokumen ini. Sangat mungkin ini adalah PDF hasil scan/hanya gambar tanpa lapisan teks tersemat. OCR offline tidak didukung.",
      limitations: {
        tables:
          "PDF tidak memiliki semantik tabel. Koordinat grid datar dan hasil keluaran berupa baris linear.",
        columns:
          "Alur teks diproses secara berurutan, urutan bacaan mungkin saling tumpang tindih.",
        scanned:
    ...
    "pdf-pages": {
      intro:
        "Muat satu atau beberapa PDF, susun ulang halaman dengan drag-and-drop, putar atau hapus halaman tertentu, lalu ekspor PDF baru — sepenuhnya di browser Anda. Memuat banyak file akan menggabungkannya sesuai urutan. Pilih halaman untuk mengekstrak subset. Tanpa unggah, tanpa akun, tanpa data yang meninggalkan perangkat Anda.",
      howItWorks: {
        step1:
          "Jatuhkan satu atau beberapa file PDF. Halaman dari setiap file muncul dalam satu daftar, sesuai urutan pemuatan — itulah hasil penggabungan Anda.",
        step2:
          "Seret baris untuk mengubah urutan, putar halaman individu 90°, hapus halaman yang tidak diinginkan, atau pilih halaman untuk diekstrak.",
        step3:
        ...
        step4:
          "pdf-lib menyalin objek halaman asli ke file baru — tanpa rasterisasi, sehingga kualitas dan kemampuan memilih teks tetap terjaga.",
      },
      useCases: {
        subtitle:
          "Gabung, pisah, dan rapikan PDF tanpa software desktop atau unggah cloud.",
        case1:
          "Gabungkan faktur, kontrak, atau halaman hasil scan dari beberapa file menjadi satu dokumen berurutan.",
        case2:
          "Pilih hanya halaman yang Anda butuhkan dan ekspor PDF yang lebih kecil — berguna untuk membagikan satu bagian dari file besar.",
        case3:
          "Susun ulang halaman setelah scan buruk atau ekspor campur aduk tanpa harus mencetak ulang atau scan ulang.",
        case4:
          "Perbaiki halaman landscape atau terbalik menjadi tegak sebelum mengekspor PDF akhir.",
      },
      faq: {
      ...
      privacyNotice:
        "Setiap PDF yang Anda muat diparse dan diproses sepenuhnya di dalam browser Anda menggunakan pdf-lib. File tidak pernah diunggah ke server, disimpan di infrastruktur kami, atau dikirim ke pihak ketiga. Tutup tab dan dokumen Anda hilang dari memori.",
    ...
    "pdf-to-image": {
      intro:
        "Konversi halaman PDF menjadi gambar JPG atau PNG berkualitas tinggi langsung di browser Anda. Pilih halaman atau rentang tertentu, sesuaikan skala resolusi, dan unduh halaman individual atau arsip ZIP gabungan. Tanpa unggah, tanpa pendaftaran — 100% privat.",
      howItWorks: {
        step1:
          "Unggah dokumen PDF Anda dengan menyeretnya masuk atau memilih file.",
        step2:
          "Pilih PNG (menjaga transparansi) atau JPG (latar belakang putih) dan atur skala render.",
        step3:
          "Pilih semua halaman atau tentukan rentang halaman khusus untuk diekstrak.",
        step4:
          "Klik Konversi dan unduh gambar Anda atau ZIP yang berisi semua halaman.",
      },
      useCases: {
        case1:
          "Konversi slide presentasi atau halaman dokumen menjadi gambar untuk disematkan di halaman web atau slide.",
        case2:
          "Ekstrak foto, tanda terima, atau diagram satu halaman dari PDF sebagai aset gambar bersih.",
        case3:
          "Ubah dokumen menjadi gambar media sosial yang tidak memerlukan pembaca PDF.",
        case4:
          "Konversi lembar keuangan sensitif secara lokal di perangkat Anda tanpa melewati server pihak ketiga.",
      },
      faq: {
      ...
      privacyNotice:
        "Alatify memproses file PDF Anda sepenuhnya secara lokal menggunakan API sandbox di dalam tab browser Anda. Kami tidak pernah mengunggah file Anda ke cloud eksternal, membuat alat ini 100% aman dari kebocoran data.",
      scaleStandard: "1x (Standar)",
      scaleHigh: "2x (Tinggi)",
      scaleMaximum: "3x (Maksimum)",
      scaleHelper:
        "Skala lebih tinggi = gambar lebih tajam, tetapi ukuran file lebih besar dan pemrosesan lebih lambat.",
    },
    "image-to-pdf": {
      intro:
        "Gabungkan beberapa gambar JPG, PNG, atau WebP menjadi satu dokumen PDF yang terorganisir dengan indah. Atur ulang halaman dengan seret-dan-lepas atau tombol geser, atur dimensi halaman, margin, dan orientasi — semuanya dihitung secara lokal di perangkat Anda.",
      howItWorks: {
        step1:
          "Tambahkan satu atau beberapa gambar (seret-dan-lepas atau pilih beberapa file).",
        step2:
          "Atur ulang halaman dengan menyeret thumbnail atau menggunakan tombol Naik/Turun.",
        step3:
          "Konfigurasikan ukuran halaman (sesuaikan dengan gambar, A4, atau Letter), orientasi, dan margin.",
        step4:
          "Hasilkan dan unduh dokumen PDF multi-halaman yang disusun secara instan.",
      },
      useCases: {
        case1:
          "Gabungkan gambar pindaian, tanda terima, atau sketsa menjadi satu dokumen PDF untuk pengiriman atau pengarsipan.",
        case2:
          "Buat portofolio digital, kompilasi foto, atau dek slide dari file desain terpisah.",
        case3:
          "Ubah urutan foto menjadi dokumen multi-halaman terstruktur untuk pembacaan yang mudah.",
        case4:
          "Susun catatan sensitif, kontrak, atau KTP secara lokal dan privat tanpa risiko kebocoran data.",
      },
      faq: {
        q1: "Apakah gambar saya diunggah ke server?",
      ...
      privacyNotice:
        "Alatify menyusun gambar Anda ke dalam PDF sepenuhnya secara lokal menggunakan API sandbox di dalam tab browser Anda. Kami tidak pernah mengunggah file Anda ke cloud eksternal, membuat alat ini 100% aman dari kebocoran data.",
    },
  },
  toolsPage: {
    intro:
      "Koleksi pilihan alat gambar yang mengutamakan privasi dan berjalan sepenuhnya di browser Anda — tanpa unggah, tanpa daftar akun, sepenuhnya privat. Mulai dari Background Remover dan Image Compressor hingga konversi format, pengubahan ukuran, dan lainnya, setiap alat memproses gambar Anda langsung di perangkat.",
  },
  "tools-image": {
    intro: "",
    nav: "",
  ...
  "url-input-help": {
    ...
    "blocked-desc":
      "Pinterest, Instagram, Facebook, and TikTok sengaja memblokir gambar mereka biar nggak bisa dimuat di luar platformnya (dikenal sebagai hotlink protection). Kalau kamu dapet error akses diblokir, ikuti langkah ini:",
